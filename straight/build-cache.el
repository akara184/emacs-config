...
(fn COMMAND &optional ARG &rest IGNORE)" t) (register-definition-prefixes "company-yasnippet" '("company-yasnippet-")) (provide 'company-autoloads)) "yasnippet" ((yasnippet-autoloads yasnippet) (autoload 'yas-minor-mode "yasnippet" "Toggle YASnippet mode.
...
(fn &optional ARG)" t) (register-definition-prefixes "markdown-mode" '("defun-markdown-" "gfm-" "markdown")) (provide 'markdown-mode-autoloads)) "eldoc" ((eldoc-autoloads eldoc eldoc-pkg) (defvar eldoc-minor-mode-string (purecopy " ElDoc") "String to display in mode line when ElDoc Mode is enabled; nil for none.") (custom-autoload 'eldoc-minor-mode-string "eldoc" t) (autoload 'eldoc-mode "eldoc" "Toggle echo area display of Lisp objects at point (ElDoc mode).
...
(fn COMMAND &optional OUTPUT-BUFFER ERROR-BUFFER ENVVAR)" t) (register-definition-prefixes "with-editor" '("server-" "shell-command" "start-file-process" "with-editor")) (provide 'with-editor-autoloads)) "magit" ((magit-autoloads git-rebase git-commit magit magit-worktree magit-wip magit-transient magit-tag magit-subtree magit-submodule magit-status magit-stash magit-sparse-checkout magit-sequence magit-reset magit-repos magit-remote magit-refs magit-reflog magit-push magit-pull magit-process magit-patch magit-notes magit-mode magit-merge magit-margin magit-log magit-gitignore magit-git magit-files magit-fetch magit-extras magit-ediff magit-diff magit-core magit-commit magit-clone magit-bundle magit-branch magit-bookmark magit-blame magit-bisect magit-base magit-autorevert magit-apply) (put 'git-commit-major-mode 'safe-local-variable (lambda (val) (memq val '(text-mode markdown-mode org-mode fundamental-mode git-commit-elisp-text-mode)))) (register-definition-prefixes "git-commit" '("git-commit-" "global-git-commit-mode")) (autoload 'git-rebase-current-line "git-rebase" "Parse current line into a `git-rebase-action' instance.
...
(fn WORKTREE PATH)" t) (register-definition-prefixes "magit-worktree" '("magit-")) (provide 'magit-autoloads)) "multiple-cursors" ((multiple-cursors-autoloads rectangular-region-mode multiple-cursors multiple-cursors-pkg multiple-cursors-core mc-separate-operations mc-mark-pop mc-mark-more mc-hide-unmatched-lines-mode mc-edit-lines mc-cycle-cursors) (register-definition-prefixes "mc-cycle-cursors" '("mc/")) (autoload 'mc/edit-lines "mc-edit-lines" "Add one cursor to each line of the active region.
...
(fn &optional ARG)" t) (define-obsolete-function-alias 'projectile-global-mode 'projectile-mode "1.0") (register-definition-prefixes "projectile" '("??" "compilation-find-file-projectile-find-compilation-buffer" "def-projectile-commander-method" "delete-file-projectile-remove-from-cache" "project" "savehist-additional-variables")) (provide 'projectile-autoloads)) "neotree" ((neotree-autoloads neotree) (autoload 'neotree-find "neotree" "Quick select node which specified PATH in NeoTree.
...
(fn &optional ARG)" t) (autoload 'all-the-icons-ivy-rich-reload "all-the-icons-ivy-rich" "Reload `all-the-icons-ivy-rich'." t) (register-definition-prefixes "all-the-icons-ivy-rich" '("all-the-icons-ivy-rich-")) (provide 'all-the-icons-ivy-rich-autoloads)) "peep-dired" ((peep-dired-autoloads peep-dired) (autoload 'peep-dired "peep-dired" "A convienent way to look up file contents in other window while browsing directory in dired
...
(fn &optional ARG)" t) (register-definition-prefixes "peep-dired" '("peep-dired-")) (provide 'peep-dired-autoloads)) "ivy-xref" ((ivy-xref-autoloads ivy-xref) (autoload 'ivy-xref-show-xrefs "ivy-xref" "Show the list of xrefs returned by FETCHER and ALIST via ivy.

(fn FETCHER ALIST)") (autoload 'ivy-xref-show-defs "ivy-xref" "Show the list of definitions returned by FETCHER and ALIST via ivy.
Will jump to the definition if only one is found.

(fn FETCHER ALIST)") (register-definition-prefixes "ivy-xref" '("ivy-xref-")) (provide 'ivy-xref-autoloads)) "powerline" ((powerline-autoloads powerline powerline-themes powerline-separators) (autoload 'powerline-hud "powerline" "Return XPM of relative buffer location using FACE1 and FACE2 of optional WIDTH.
