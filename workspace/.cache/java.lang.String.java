...
public final class String implements Serializable, Comparable<String>, CharSequence, Constable, ConstantDesc {
      ...
      if (length == 0) {
         ...
         if (charset == UTF_8.INSTANCE) {
            ...
            if (COMPACT_STRINGS && !StringCoding.hasNegatives(bytes, offset, length)) {
               ...
               while(sl < length) {
                  int b = bytes[offset++];
                  StringUTF16.putChar(dst, sl++, b >= 0 ? (char)b : '\ufffd');
               }
   ...
   private static byte[] encodeWithEncoder(Charset cs, byte coder, byte[] val, boolean doReplace) {
      ...
      if (doReplace && ce instanceof ArrayEncoder) {
         ArrayEncoder ae = (ArrayEncoder)ce;
   ...
   public String indent(int param1) {
   ...
   public String stripIndent() {
      ...
      if (length == 0) {
         ...
         return (String)lines.stream().map((Function)outdent).collect(Collectors.joining("\n", "", optOut ? "\n" : ""));
      }
   }
